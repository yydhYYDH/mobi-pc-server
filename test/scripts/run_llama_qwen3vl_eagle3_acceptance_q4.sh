...
TARGET_Q4="models/Qwen-Qwen3-VL-2B-Instruct-gguf/Qwen-Qwen3-VL-2B-Instruct-f16-q4_k_m.gguf"
MMPROJ="models/Qwen-Qwen3-VL-2B-Instruct-gguf/mmproj-Qwen-Qwen3-VL-2B-Instruct-f16.gguf"
DRAFT_Q4="models/MNN-Qwen3-VL-2B-Instruct-Eagle3-gguf/MNN-Qwen3-VL-2B-Instruct-Eagle3-f16-q4_k_m.gguf"
...
run_case "qwen3vl-taobao-q4-draft-q4" \
  --model "$TARGET_Q4" \
  --mmproj "$MMPROJ" \
  --image "$IMAGE" \
  --file "$PROMPT_FILE" \
