...
mac:
  ...
  target:
    - dmg
    - zip
  artifactName: "ClawMate-${version}-${os}-${arch}.${ext}"
```
...
```bash
mkdir -p /tmp/ClawMate-icon.iconset
sips -z 16 16 desktop/build/icon.png --out /tmp/ClawMate-icon.iconset/icon_16x16.png
sips -z 32 32 desktop/build/icon.png --out /tmp/ClawMate-icon.iconset/icon_16x16@2x.png
sips -z 32 32 desktop/build/icon.png --out /tmp/ClawMate-icon.iconset/icon_32x32.png
sips -z 64 64 desktop/build/icon.png --out /tmp/ClawMate-icon.iconset/icon_32x32@2x.png
sips -z 128 128 desktop/build/icon.png --out /tmp/ClawMate-icon.iconset/icon_128x128.png
sips -z 256 256 desktop/build/icon.png --out /tmp/ClawMate-icon.iconset/icon_128x128@2x.png
sips -z 256 256 desktop/build/icon.png --out /tmp/ClawMate-icon.iconset/icon_256x256.png
sips -z 512 512 desktop/build/icon.png --out /tmp/ClawMate-icon.iconset/icon_256x256@2x.png
sips -z 512 512 desktop/build/icon.png --out /tmp/ClawMate-icon.iconset/icon_512x512.png
sips -z 1024 1024 desktop/build/icon.png --out /tmp/ClawMate-icon.iconset/icon_512x512@2x.png
iconutil -c icns /tmp/ClawMate-icon.iconset -o desktop/build/icon.icns
```
